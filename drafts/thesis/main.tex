...
\section{Theory of Linear Response in a Nutshell}
    ...
    \begin{equation} \label{eq:classical_def_inverse}
        V(\mathbf{r}, t) 
    ...
    \begin{equation} \label{eq:classical_dielectric_fourier}
    ...
    Taking Fourier transform of eq. \eqref{eq:classical_def_inverse}, we obtain\footnote{ %
\begin{equation*}
\begin{aligned}
    V(\mathbf{r}, \omega) 
...
\end{equation*}
    ...
    \begin{equation} \label{eq:classical_def_inverse_fourier}
        V(\mathbf{r}, \omega) 
            = \int\!\! \text{d}^3 r' \; \varepsilon^{-1}(\mathbf{r}, \mathbf{r'}, \omega) V_\text{ext}(\mathbf{r'}, \omega)\; .
    \end{equation}
    Eqs. \eqref{eq:classical_dielectric_fourier} and \eqref{eq:classical_def_inverse_fourier} may equivalently be formulated as 
    \begin{equation} \label{eq:classical_result}
    \begin{aligned}
    ...
    \begin{aligned}
        ...
        \implies \hat \chi(t) &= \sum_{i,j} G_{i,j}\, \langle i| \hat V|j\rangle \, e^{-i (\omega + i\eta) t}\; | i \rangle\!\langle j |
    \end{aligned}
    \end{equation}
    ...
    \end{equation}
    where $\hat V_\text{Coulomb}$ is the Coulomb interaction potential. Using the fact that $\hat V$ is diagonal, in position representation eq. \eqref{eq:self_consistency} reads\footnote{ %
At point $\mathbf{r}$ we have
    ...
    \begin{aligned}
        \langle \mathbf{r}|\hat V_\text{ext}(t) | \mathbf{r} \rangle 
            ...
            &\overset{\eqref{eq:def_chi_function}}{=} \langle \mathbf{r} | \hat V | \mathbf{r} \rangle e^{-i (\omega + i\eta) t}- \int\!\! \text{d}^3 r' \; \frac{e^2}{\| \mathbf{r} - \mathbf{r'} \|} \sum_{i,j} G_{i,j}\, e^{-i (\omega + i\eta) t} \, \langle j |\mathbf{r'}\rangle\langle\mathbf{r'} | i \rangle\langle i | \hat V | j \rangle \\
    ...
    \begin{aligned}
        ...
        \langle \mathbf{r} | \hat \varepsilon(t) | \mathbf{r'} \rangle &= \left( \langle \mathbf{r} | \mathbf{r'} \rangle - \sum_{i,j} G_{i,j} \int\!\! \text{d}^3 r'' \; \frac{e^2}{\| \mathbf{r} - \mathbf{r''} \|} \, \langle j |\mathbf{r''}\rangle \langle\mathbf{r''} | i \rangle \langle i | \mathbf{r'}\rangle \langle \mathbf{r'} | j \rangle \right) \, e^{-i (\omega + i\eta) t}\; .
    \end{aligned}
    \end{equation*}
    ...
    \begin{aligned}
        ...
        \langle \mathbf{r} | \hat \varepsilon(\omega) | \mathbf{r'} \rangle 
            ...
            &=  \langle \mathbf{r} | \mathbf{r'} \rangle - \sum_{i,j} \lim_{\eta \to 0+} G_{i,j} \int\!\! \text{d}^3 r'' \; \frac{e^2}{\| \mathbf{r} - \mathbf{r''} \|} \, \langle j |\mathbf{r''}\rangle \langle\mathbf{r''} | i \rangle \langle i | \mathbf{r'}\rangle \langle \mathbf{r'} | j \rangle\; ,
    \end{aligned}
    \end{equation}
    which is the exact equivalent of eq. \eqref{eq:classical_result} in the classical description.
